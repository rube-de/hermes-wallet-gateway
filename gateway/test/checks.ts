...
const WHITELISTED_PK = '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80' as Hex;
...
async function login(base: string, account: Account): Promise<LoginResult> {
